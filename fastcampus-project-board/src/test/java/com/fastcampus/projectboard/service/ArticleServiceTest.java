...
class ArticleServiceTest {
    ...
    void givenArticleInfo_whenSavingArticle_thenSavesArticle() {
        ...
        //When
        sut.saveArticle(ArticleDto.of(LocalDateTime.now(), "koy1208",   "titile", "content", "#java"));
    ...
    @Test
    void givenIdAndModifiedInfo_whenSavingArticle_thenUpdatesArticle() {
        //Given
        given(articleRepository.save(any(Article.class))).willReturn(null);

        //When
        sut.updateArticle(1L, ArticleUpdateDto.of("titile", "content", "#java"));
    ...
    @Test
    void givenId_whenDeletingArticle_thenDeletesArticle() {
        //Given
